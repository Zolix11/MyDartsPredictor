        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthUID = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Name = table.Column<string>(type: "text", nullable: false),
                    FoundationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<int>(type: "integer", nullable: false),
                    PredictionWinner = table.Column<int>(type: "integer", nullable: false),
                    PredictionScore = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    GameId = table.Column<int>(type: "integer", nullable: false),
                    WinnerPlayer = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "AuthUID", "Name" },
                values: new object[,]
                {
                    { 1, "EJEgB8nlGpNt9DMN8ig5Gq6ETzA2", "Zolix" },
                    { 2, "CNH4Se4MIbXI3CwJhUEldSpnVoK2", "Pista" }
                });

            migrationBuilder.InsertData(
                table: "Tournaments",
                columns: new[] { "Id", "FoundationTime", "FounderUserId", "Name" },
                values: new object[] { 1, new DateTime(2023, 6, 20, 17, 11, 28, 985, DateTimeKind.Utc).AddTicks(2421), 1, "Szupi Tournament" });
